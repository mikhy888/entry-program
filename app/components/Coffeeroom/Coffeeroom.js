...
import cafImage from './images/coffeeroom.jpg';

let sectioncontent = "Find the Coffee room!";

let i = "";

const first = { left: '62%', top: '19%' };
const second = { left: '77%', top: '50%' };
const third = { left: '4%', top: '48%' };
const fourth = { left: '50%', top: '68%' };
